...
@view_config(
    ...
    permission='import',
    request_method='GET',
    renderer='../templates/codebook/occams_codebook.pt'
)
@view_config(
    route_name='imports.codebooks_iform',
    permission='import',
    request_method='GET',
    renderer='../templates/codebook/iform_codebook.pt'
)
@view_config(
    route_name='imports.codebooks_qds',
    permission='import',
    request_method='GET',
    renderer='../templates/codebook/qds_codebook.pt'
)
...
@view_config(
    ...
    permission='import',
    request_method='POST',
    renderer='../templates/codebook/status.pt'
)
