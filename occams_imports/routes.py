...
def includeme(config):
    ...
    config.add_route('imports.process_app',                 '/process',                                                     factory=models.ImportFactory)
    config.add_route('imports.upload_list',                 '/api/projects/{project}/uploads',                              factory=models.ProjectFactory)
    config.add_route('imports.upload_detail',               '/api/projects/{project}/uploads/{upload}',                     factory=models.ProjectFactory)

    config.add_route('imports.process_status',              '/api/process/status',                                          factory=models.ProjectFactory)
    config.add_route('imports.process_project',             '/api/process/{project}',                                                 factory=models.ProjectFactory)
    config.add_route('imports.process',                     '/api/process',                                                 factory=models.ProjectFactory)
