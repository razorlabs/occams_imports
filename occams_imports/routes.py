...
def includeme(config):
    ...
    config.add_route('imports.demos.jointjs',               '/demos/jointjs',             factory=models.RootFactory)
    config.add_route('imports.demos.cytoscapejs',           '/demos/cytoscapejs',         factory=models.RootFactory)
