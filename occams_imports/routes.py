...
def includeme(config):
    ...
    config.add_route('imports.codebooks_iform_status',      '/codebooks/iform/status',    factory=models.ImportFactory)
    config.add_route('imports.codebooks_occams_status',     '/codebooks/occams/status',   factory=models.ImportFactory)
    config.add_route('imports.codebooks_qds_status',        '/codebooks/qds/status',      factory=models.ImportFactory)
    ...
    config.add_route('imports.mappings.delete',             '/mappings/delete',           factory=models.RootFactory)
    config.add_route('imports.mappings.imputation.demo',    '/mappings/imputation/demo',  factory=models.RootFactory)
